...
```json
{
  ...
  "includeTap" : true,
  "interfaceType" : "http",
  "projectName" : "python-function-microservice1"
}
```
## Log
```
...
┃ ┃ ┃ ┗ ┗ ┗  Info Will replace [my-python-fn->python-function-micr...(truncated), main->hello]
...
┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [https://github.com/sample-accelerators/python-functions-accelerator.git->https://github.com/s...(truncated), my-python-fn->python-function-micr...(truncated), main->main]
...
┃ ┃ ┗ ┗ ┗ ┗  Info Will replace [my-python-fn->python-function-micr...(truncated)]
